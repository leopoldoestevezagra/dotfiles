--[[
--Some modifications were made by me but this whole configuration was made
--mainly by
  ____ _____
 ...
 Many thanks for this " awesome " config ;)
...
globalkeys = my_table.join(
  ...
  -- screenshots
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    awful.key({ modkey, "Shift"}, "l", function () os.execute("i3lock -i ~/Pictures/Wallpapers/anchor_drawing_vector_dark_93570_1920x1080.png") end,
